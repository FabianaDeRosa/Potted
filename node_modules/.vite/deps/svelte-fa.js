...
function add_css(target) {
  append_styles(target, "svelte-xj8byo", ".spin.svelte-xj8byo{animation:svelte-xj8byo-spin 2s 0s infinite linear}.pulse.svelte-xj8byo{animation:svelte-xj8byo-spin 1s infinite steps(8)}@keyframes svelte-xj8byo-spin{0%{transform:rotate(0deg)}100%{transform:rotate(360deg)}}\n/*# sourceMappingURL=data:application/json;charset=utf-8;base64, */");
}
function create_if_block(ctx) {
  ...
  const block = {
    ...
    h: function hydrate() {
      ...
      add_location(svg, file, 67, 2, 1072);
    },
...
function create_else_block(ctx) {
  ...
  const block = {
    ...
    h: function hydrate() {
      ...
      ctx[10][0] / -2 + " " + /*i*/
      ctx[10][1] / -2 + ")");
      add_location(path0, file, 91, 10, 1679);
      ...
      ctx[10][0] / -2 + " " + /*i*/
      ctx[10][1] / -2 + ")");
      add_location(path1, file, 97, 10, 1936);
    },
    m: function mount(target, anchor) {
...
function create_if_block_1(ctx) {
  ...
  const block = {
    ...
    h: function hydrate() {
      ...
      ctx[10][0] / -2 + " " + /*i*/
      ctx[10][1] / -2 + ")");
      add_location(path, file, 84, 10, 1462);
    },
    m: function mount(target, anchor) {
